...
var DragMixin = /** @class */ (function (_super) {
    ...
    DragMixin.prototype.onMouseMove = function (e) {
        ...
        if (!this.dragStarted && dist > this.delta) {
            ...
            if (!this.dragInitialised) {
                ...
                exports.dnd.startDrag(this, this.downEvent, this.startPosition.x, this.startPosition.y, this.type, this.data);
    ...
    DragMixin.prototype.created = function () {
        exports.dnd.on('dragstart', this.dndDragStart);
        exports.dnd.on('dragend', this.dndDragEnd);
    };
    ...
    DragMixin.prototype.beforeDestroy = function () {
        exports.dnd.off('dragstart', this.dndDragStart);
        exports.dnd.off('dragend', this.dndDragEnd);
...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c(_vm.tag,_vm._g(_vm._b({tag:"component",class:_vm.cssClasses,scopedSlots:_vm._u([_vm._l((_vm.$scopedSlots),function(_,slot){return {key:slot,fn:function(scope){return [_vm._t(slot,null,null,scope)]}}})],null,true)},'component',_vm.$attrs,false),_vm.$listeners),[_vm._t("default"),(_vm.dragInitialised)?_c('div',{ref:"drag-image",staticClass:"__drag-image"},[_vm._t("drag-image")],2):_vm._e()],2)};
var __vue_staticRenderFns__ = [];

  /* style */
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-7967a0fd_0", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}.drag-no-handle:hover{cursor:move;cursor:grab}", map: undefined, media: undefined })
,inject("data-v-7967a0fd_1", { source: "html.drag-in-progress *{cursor:move!important;cursor:grabbing!important}", map: undefined, media: undefined })
,inject("data-v-7967a0fd_2", { source: ".__drag-image[data-v-7967a0fd]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-7967a0fd";
  /* module identifier */
  var __vue_module_identifier__ = "data-v-7967a0fd";
  /* functional template */
...
var __vue_staticRenderFns__$1 = [];
  ...
  var __vue_inject_styles__$1 = function (inject) {
    if (!inject) { return }
    inject("data-v-16643cc7_0", { source: ".drop-allowed.drop-in,.drop-allowed.drop-in *{cursor:pointer!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined })
,inject("data-v-16643cc7_1", { source: ".__drag-image[data-v-16643cc7]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$1 = "data-v-16643cc7";
  /* module identifier */
  var __vue_module_identifier__$1 = "data-v-16643cc7";
  /* functional template */
...
var Grid = /** @class */ (function () {
    function Grid(collection, upToIndex, direction, fromIndex) {
        var e_1, _a;
        this.magnets = [];
        ...
        try {
            for (var collection_1 = __values(collection), collection_1_1 = collection_1.next(); !collection_1_1.done; collection_1_1 = collection_1.next()) {
                ...
                if (fromIndex === null) {
                    ...
                    // Reordering mode.
                    this.magnets.push(hasNestedDrop ? (fromIndex < index ? this.after : this.before)(rect, isHorizontal) : this.center(rect));
                }
                // Debug : show magnets :
...
var ReorderEvent = /** @class */ (function (_super) {
    __extends(ReorderEvent, _super);
    function ReorderEvent(from, to, event) {
        var _this = _super.call(this) || this;
        Object.assign(_this, event);
        _this.to = to;
        _this.from = from;
        return _this;
    }
...
var InsertEvent = /** @class */ (function (_super) {
    __extends(InsertEvent, _super);
    function InsertEvent(type, data, index, event) {
        var _this = _super.call(this) || this;
        Object.assign(_this, event);
        _this.type = type;
        _this.data = data;
...
var LeaveEvent = /** @class */ (function (_super) {
    __extends(LeaveEvent, _super);
    function LeaveEvent(index, event) {
        var _this = _super.call(this) || this;
        Object.assign(_this, event);
        _this.index = index;
        return _this;
    ...
    DropList.prototype.doDrop = function (event) {
        if (this.reordering) {
            if (this.fromIndex !== this.closestIndex) {
                this.$emit('reorder', new ReorderEvent(this.fromIndex, this.closestIndex, event));
            }
            else {
            ...
            this.$emit('insert', new InsertEvent(event.type, event.data, this.closestIndex, event));
        }
    };
