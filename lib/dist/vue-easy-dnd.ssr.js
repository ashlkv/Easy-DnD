...
var __vue_staticRenderFns__ = [];
  ...
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-175450fe_0", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}.drag-no-handle:hover{cursor:move;cursor:grab}", map: undefined, media: undefined })
,inject("data-v-175450fe_1", { source: "html.drag-in-progress *{cursor:move!important;cursor:grabbing!important}", map: undefined, media: undefined })
,inject("data-v-175450fe_2", { source: ".__drag-image[data-v-175450fe]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-175450fe";
  /* module identifier */
  var __vue_module_identifier__ = "data-v-175450fe";
  /* functional template */
...
var Grid = /** @class */ (function () {
        ...
        try {
            for (var collection_1 = __values(collection), collection_1_1 = collection_1.next(); !collection_1_1.done; collection_1_1 = collection_1.next()) {
                ...
                if (fromIndex === null) {
                    ...
                    // Reordering mode.
                    this.magnets.push(hasNestedDrop ? (fromIndex < index ? this.after : this.before)(rect, this.horizontal) : this.center(rect));
                }
                // Debug : show magnets :
    ...
    Grid.prototype.closestIndex = function (position) {
        ...
        for (var i = 0; i < this.magnets.length; i++) {
            ...
            var dist = this.horizontal ? Math.abs(magnet.x - x) : Math.abs(magnet.y - y);
            if (dist < minDist) {
                minDist = dist;
                index = i;
            }
...
var __vue_staticRenderFns__$4 = [];
  ...
  var __vue_inject_styles__$4 = function (inject) {
    if (!inject) { return }
    inject("data-v-0f328973_0", { source: ".drop-list[data-v-0f328973]>*{transition:transform .2s}.__feedback[data-v-0f328973]{display:none}.__drag-image[data-v-0f328973]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined })
,inject("data-v-0f328973_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$4 = "data-v-0f328973";
  /* module identifier */
  var __vue_module_identifier__$4 = "data-v-0f328973";
  /* functional template */
